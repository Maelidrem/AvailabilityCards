...
namespace CreateCards
{
    ...
    public class Test
    {
        ...
        {
            string json;
            using (StreamReader r = new StreamReader(System.AppDomain.CurrentDomain.BaseDirectory +  @"/test.json"))
            {
                json = r.ReadToEnd();
            }
            ...
            image.Save(@"d:\header.png", System.Drawing.Imaging.ImageFormat.Png);
            Assert.IsTrue(true);
        }
    }
}
